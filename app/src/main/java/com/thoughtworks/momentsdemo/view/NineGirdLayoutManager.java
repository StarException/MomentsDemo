...
public class NineGirdLayoutManager extends RecyclerView.LayoutManager {
    ...
    public NineGirdLayoutManager(Context context) {
    ...
    private void fill(RecyclerView.Recycler recycler) {
        ...
        for (int i = 0; i < getItemCount(); i++) {
            ...
            Log.d("recycler","layoutChild:height:"+frame.height());
